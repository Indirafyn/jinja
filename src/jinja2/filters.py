...
# Refactoring: Remove Duplicate Import (removed redundant bare `import typing`)
import typing as t
...
# Refactoring: Extract Method — repeated inline expression extracted into a helper.
...
# Refactoring: Replace Magic Literal with Symbolic Constant — repeated string
# literals replaced with named module-level constants.
